    ...
    <section class="bg-[#062645] py-16">
        <div class="max-w-7xl mx-auto px-6 text-center text-white">
            ...
            <p class="max-w-2xl mx-auto text-gray-200">
                The 12th Science program focuses on advanced concepts and
                exam-oriented preparation to help students succeed in board
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div class="science-text">
                    ...
                    <p class="text-gray-700 mb-4 leading-relaxed">
                        The 12th Science curriculum at R.K. Desai School is designed
                        to strengthen conceptual understanding while focusing on
                        board examinations and competitive exam readiness.
                    </p>

                    <p class="text-gray-700 leading-relaxed">
                        Students receive structured guidance, regular assessments,
                        and expert mentoring to help them achieve academic excellence
                        and confidently plan their future careers.
                    </p>
                </div>
                ...
                <div class="science-img flex justify-center">
                    <img
                        src="../img/12-science.jpg"
                        alt="12th Science Classroom"
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="overflow-x-auto">
                <table class="science-table w-full border-collapse rounded-xl overflow-hidden shadow-lg">
...
<script>
    ...
    gsap.from(".science-table tbody tr", {
        scrollTrigger: {
            trigger: ".science-table",
            start: "top 80%",
        },
        opacity: 0,
        y: 30,
