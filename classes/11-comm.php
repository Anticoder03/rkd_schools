    ...
    <section class="bg-[#062645] py-16">
        <div class="max-w-7xl mx-auto px-6 text-center text-white">
            ...
            <p class="max-w-2xl mx-auto text-gray-200">
                The 11th Commerce program focuses on building a strong foundation
                in business, economics, and financial understanding for future
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div class="commerce-text">
                    ...
                    <p class="text-gray-700 mb-4 leading-relaxed">
                        The 11th Commerce curriculum at R.K. Desai School is designed
                        to introduce students to the fundamentals of commerce,
                        business studies, and economics in a structured manner.
                    </p>

                    <p class="text-gray-700 leading-relaxed">
                        Students gain conceptual clarity, analytical thinking,
                        and practical understanding that prepares them for higher
                        studies in commerce, management, and related fields.
                    </p>
                </div>
